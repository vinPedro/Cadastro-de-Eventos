...
public class Evento{
	...
	//remove um usuário da lista de participantes do evento pelo index(lugar na lista) do participante
	...
	//remove um usuário da lista de participantes do evento pelo passando o proprio participante recuperado da lista de inscricoes
